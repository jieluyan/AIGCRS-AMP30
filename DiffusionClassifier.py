...
class DiffusionModel(keras.Model):
    ...
    def sample2seqs(self, samples, t, c=7.5, target=1):
        ...
        if len(new_seqs) == 0:
            ...
            os.makedirs("result/cls_timestep", exist_ok=True)
    ...
    def genetoken2seqs(self, generated_tokens):
        ...
        seqs = tokens2seqs(gene_tokens, scaled=False)
        return seqs
    def generate_AMPs(self, num=1000, label=1):
    ...
    def geneTokens_refineByCls(self, num_images, y_label):
        ...
        p_mets = ("./pics/newClassifierGuidance-Diffusion-Yan-Model_%depoch_%dtiemstep_%s_%.2fscale_clip-metrics600cls.csv" %
        ...
        plt.savefig("./pics/newClassifierGuidance-Diffusion-Yan-Model_%depoch_%dtiemstep_%s_%.2fscale_clip-metrics600cls.png" %
                    (num_epochs, total_timesteps, loss_name, guidance_scale))
        plt.close()
